          ...
          <div class="card mb-3">
            <div class="card-body">
              <form role="form" method="post" action="" autocomplete="off">
                ...
                <?php if ($msg->hasMessages()){ $msg->display(); $error=1; } ?>
                <div class="form-group">
                  <input type="text" name="nickname" id="nickname" 
class="form-control input-lg" placeholder="nickname" value="<?php if(isset($error)){ echo htmlspecialchars($_POST['nickname'], ENT_QUOTES); } ?>" tabindex="1">
                </div>
